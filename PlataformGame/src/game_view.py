...
from constants import SCREEN_WIDTH, PLAYER_MAX_HEALTH, PLAYER_SCALE, PLAYER_SPEED, TILE_SCALE, TILE_SIZE, GRAVITY
import arcade
...
class GameView(arcade.View):
    def __init__(self, window = None):
        ...
        self.player = Player('../sprites/frog.png', PLAYER_SCALE, PLAYER_SPEED, PLAYER_MAX_HEALTH)
